...
router.post('/', async (req, res) => {
    ...
    let templates = [
        {
            ...
            \`\`\`
            Use the following pieces of context to answer the users question and REMOVE ANY GREETING MESSEAGE SUCH AS "HI" OR "HELLO" IN YOUR REPLY.
    ...
    const defaultPrompt = ChatPromptTemplate.fromPromptMessages([
        SystemMessagePromptTemplate.fromTemplate(
            ...
            `Your job is to answer any questions that customers have. If there is any question that you do not know, say that you do not know and refer them to contact Geri at 84430486. REMOVE ANY GREETING MESSEAGE SUCH AS "HI" OR "HELLO" IN YOUR REPLY.`
        ),
