...
App.post('/chatgpt', async (req, res) => {
    ...
    const promptNames = ["agent", "client", "general"]
    const promptDescriptions = [ "Good for replying enquiry made by a real estate agent who wants to co-broke and wants information on a particular property", 
    "Good for replying enquiries made by non real estate agents who wants information on a particular property",
    "Good for replying generic enquiries"
    ]

    const agentTemplate = `You are a helpful real estate agent Bot from Huttons Sales & Auction.` +
    ...
    const clientTemplate = `You are a helpful real estate agent Bot from Huttons Sales & Auction.` +
    ...
    const generalTemplate = `You are a helpful real estate agent Bot from Huttons Sales & Auction.` +
    ...
    const promptTemplates = [agentTemplate, clientTemplate, generalTemplate]
