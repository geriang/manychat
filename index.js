...
App.post('/chatgpt', async (req, res) => {
    ...
    const executor = await initializeAgentExecutorWithOptions(tools, llm, {
        ...
        agentArgs: {
            ...
            prefix: "You are a chatbot that answers to enquires. Always ask for a name if it is not found in chat history or chat record. If a name is found, greet the person by name.",
